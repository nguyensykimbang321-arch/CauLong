...
import { createBookingByHotlineSchema, updateBookingStatusSchema, getDailyBookedSchema } from '../../validations/booking.validation.js';
...
router.get(
    ...
    validate(getDailyBookedSchema),
    AdminBookingController.getDailyBooked
);
